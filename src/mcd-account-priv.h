...
#define MC_ACCOUNTS_KEY_DISPLAY_NAME "display_name"
#define MC_ACCOUNTS_KEY_ICON_NAME "icon_name"
#define MC_ACCOUNTS_KEY_NORMALIZED_NAME "normalized_name"
