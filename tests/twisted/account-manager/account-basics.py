...
def test(q, bus, mc):
    ...
    q.expect_many(
        EventPattern('dbus-signal',
            ...
            args=[cs.ACCOUNT, {'DisplayName': 'Work account'}, []]),
        EventPattern('dbus-signal',
    ...
    q.expect_many(
        EventPattern('dbus-signal',
            ...
            signal='PropertiesChanged',
            interface=cs.PROPERTIES_IFACE,
            args=[cs.ACCOUNT, {'Icon': 'im-jabber'}, []]),
        EventPattern('dbus-signal',
            interface=cs.TEST_DBUS_ACCOUNT_PLUGIN_IFACE,
            signal='DeferringSetAttribute',
    ...
    q.expect_many(
        EventPattern('dbus-signal',
            ...
            signal='PropertiesChanged',
            interface=cs.PROPERTIES_IFACE,
            args=[cs.ACCOUNT, {'Nickname': 'Joe Bloggs'}, []]),
        EventPattern('dbus-return', method='Set'),
        EventPattern('dbus-signal',
            interface=cs.TEST_DBUS_ACCOUNT_PLUGIN_IFACE,
            signal='DeferringSetAttribute',
    ...
    q.expect_many(
        EventPattern('dbus-signal',
            ...
            signal='PropertiesChanged',
            interface=cs.PROPERTIES_IFACE,
            args=[cs.ACCOUNT, {'Supersedes': [cs.ACCOUNT_PATH_PREFIX + 'x/y/z']}, []]),
        EventPattern('dbus-return', method='Set'),
        EventPattern('dbus-signal',
            interface=cs.TEST_DBUS_ACCOUNT_PLUGIN_IFACE,
            signal='DeferringSetAttribute',
