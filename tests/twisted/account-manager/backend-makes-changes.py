...
def test(q, bus, mc, fake_accounts_service=None, **kwargs):
    ...
    q.expect_many(
        EventPattern('dbus-signal',
            ...
            # this PropertiesChanged signal. MC should stop merging
            # unrelated signals one day...
            predicate=(lambda e:
                e.args[1].get('Nickname') == 'Ezio Auditore di Firenze')),
        EventPattern('dbus-signal',
    ...
    q.expect_many(
            ...
            EventPattern('dbus-signal',
                ...
                interface=cs.PROPERTIES_IFACE,
                predicate=(lambda e:
                    e.args[1].get('ConnectAutomatically') == True)),
            EventPattern('dbus-signal',
                path=cs.TEST_DBUS_ACCOUNT_PLUGIN_PATH,
                signal='AttributeChanged',
    ...
    q.expect_many(
            ...
            EventPattern('dbus-signal',
                ...
                signal='PropertiesChanged',
                interface=cs.PROPERTIES_IFACE,
                args=[cs.ACCOUNT, {'AutomaticPresence':
    ...
    q.expect_many(
            ...
            EventPattern('dbus-signal',
                ...
                signal='PropertiesChanged',
                interface=cs.PROPERTIES_IFACE,
                args=[cs.ACCOUNT, {'DisplayName': 'Ezio\'s IM account'}, []]),
            EventPattern('dbus-signal',
                path=cs.TEST_DBUS_ACCOUNT_PLUGIN_PATH,
                signal='AttributeChanged',
    ...
    q.expect_many(
            ...
            EventPattern('dbus-signal',
                ...
                signal='PropertiesChanged',
                interface=cs.PROPERTIES_IFACE,
                args=[cs.ACCOUNT, {'Icon': 'im-machiavelli'}, []]),
            EventPattern('dbus-signal',
                path=cs.TEST_DBUS_ACCOUNT_PLUGIN_PATH,
                signal='AttributeChanged',
    ...
    q.expect_many(
            ...
            EventPattern('dbus-signal',
                ...
                signal='PropertiesChanged',
                interface=cs.PROPERTIES_IFACE,
                args=[cs.ACCOUNT, {'Service': 'machiavelli-talk'}, []]),
            EventPattern('dbus-signal',
                path=cs.TEST_DBUS_ACCOUNT_PLUGIN_PATH,
                signal='AttributeChanged',
